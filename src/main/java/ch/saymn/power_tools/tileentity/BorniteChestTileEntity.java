...
import ch.saymn.power_tools.container.ChestContainer;
...
public class BorniteChestTileEntity extends LockableLootTileEntity implements IChestLid, ITickableTileEntity
{
    ...
    protected BorniteChestTileEntity(TileEntityType<?> typeIn, ChestType chestTypeIn, Block blockToUseIn)
    {
        super(typeIn);
    ...
    public BorniteChestTileEntity()
    {
        this(ChestTileEntityType.BORNITE_CHEST, ChestType.BORNITE, BorniteChestBlocks.borniteChestBlock);
    }
    ...
    public static int getPlayersUsing(IBlockReader reader, BlockPos posIn)
    {
        ...
        if (blockstate.hasTileEntity())
        {
            ...
            if (tileentity instanceof BorniteChestTileEntity)
            {
                return ((BorniteChestTileEntity) tileentity).numPlayersUsing;
            }
        }
    ...
    {
        return ChestContainer.createBorniteContainer(windowId, playerInventory, this);
    }
    ...
    {
        ChestType type = ChestType.BORNITE;
